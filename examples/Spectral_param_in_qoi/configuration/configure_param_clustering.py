...
pipeline_configuration[1]['function_calls'][0]['function'] = 'transform_spectral'
...
pipeline_configuration[1]['function_calls'][0]['args']['kwargs']['spectral'] = OrderedDict()
...
pipeline_configuration[3]['function_calls'][0]['args']['x_axis'] = 'spectral_0'
pipeline_configuration[3]['function_calls'][0]['args']['y_axis'] = 'spectral_1'
pipeline_configuration[3]['function_calls'][0]['args']['filename'] = 'param_clusters_in_spectral_space.png'
