...
pipeline_configuration[0]['function_calls'][0]['args']['cols'] = ['err']
...
pipeline_configuration[1]['function_calls'][0]['args']['cols'] = ['n_err']
...
pipeline_configuration[3]['function_calls'][0]['args']['filename'] = 'err_clusters_in_pca_space.png'
