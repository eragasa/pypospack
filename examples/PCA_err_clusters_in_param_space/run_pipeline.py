...
config_fn_0 = os.path.join(pypospack_root_dir,
                           configuration_dir,
                           'configure_err_clustering.in')
config_fn_1 = os.path.join(pypospack_root_dir,
                           configuration_dir,
                           'configure_param_pca_transform.in')
...
if __name__ == "__main__":
    # normalize, pca transform, and cluster error space
    ...
    # normalize and pca transform parameter space
    ...
    # plot error clusters in parameter space
