...
pyposmat_qoi_config_fn = os.path.join(pypospack_root_dir, 'examples/PCA_Analysis/configure_qoi_pca_transform.in')
...
if __name__ == "__main__":
    ...
    plot_pipeline = PyposmatPipeline(configuration_fn=pyposmat_qoi_plot_config_fn,
                                     df=qoi_pipeline.df)
    plot_pipeline.read_configuration(pyposmat_qoi_plot_config_fn)
    plot_pipeline.run()
