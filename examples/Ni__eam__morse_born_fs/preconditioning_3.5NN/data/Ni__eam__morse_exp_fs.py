...
structure_db_directory = os.path.join(pypospack_root_directory,'data','Ni_structure_db')
...
# Girifalco 1958, Phys Rev B. "application of the Morse Potential Function to Cubic Metals"
...
structure_db['structure_directory'] = structure_db_directory
