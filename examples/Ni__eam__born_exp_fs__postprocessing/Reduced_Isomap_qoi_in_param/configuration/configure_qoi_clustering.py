...
# define third segment (Isomap transformation)
...
pipeline_configuration[2]['function_calls'][0]['function'] = 'transform_isomap'
...
pipeline_configuration[4]['function_calls'][0]['args']['x_axis'] = 'isomap_0'
pipeline_configuration[4]['function_calls'][0]['args']['y_axis'] = 'isomap_1'
pipeline_configuration[4]['function_calls'][0]['args']['filename'] = 'qoi_in_qoi_iteration_20.png'
