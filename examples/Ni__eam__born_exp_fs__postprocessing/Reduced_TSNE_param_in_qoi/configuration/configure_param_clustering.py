...
pipeline_configuration[3]['function_calls'][0]['args']['kwargs']['kmeans']['n_clusters'] = 10
...
pipeline_configuration[4]['function_calls'][0]['args']['filename'] = 'param_clusters_in_tsne_space.png'
