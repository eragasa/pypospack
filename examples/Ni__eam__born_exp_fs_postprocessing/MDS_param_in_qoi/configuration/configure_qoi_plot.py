...
pipeline_configuration[0]['function_calls'][0]['args']['x_axis'] = 'mds_0'
pipeline_configuration[0]['function_calls'][0]['args']['y_axis'] = 'mds_1'
pipeline_configuration[0]['function_calls'][0]['args']['filename'] = 'param_clusters_in_qoi_mds_space.png'
