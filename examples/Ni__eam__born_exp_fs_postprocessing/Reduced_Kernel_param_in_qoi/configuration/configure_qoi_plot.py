...
pipeline_configuration[0]['function_calls'][0]['args']['x_axis'] = 'kernel_pca_1'
pipeline_configuration[0]['function_calls'][0]['args']['y_axis'] = 'kernel_pca_2'
pipeline_configuration[0]['function_calls'][0]['args']['filename'] = 'param_clusters_in_qoi_kernel_pca_space.png'
