...
pipeline_configuration[3]['function_calls'][0]['function'] = 'plot_kde_by_cluster'
...
pipeline_configuration[3]['function_calls'][0]['args']['filename'] = 'param_kde_in_pca_space.png'
