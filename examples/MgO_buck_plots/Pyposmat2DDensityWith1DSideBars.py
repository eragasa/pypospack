...
class Pyposmat2DDensityPlots(PyposmatDataFileVisualization):
    ...
    def plot(self,
        ...
        xlabel = self.configuration.latex_labels[x_name]['name']
        ylabel = self.configuration.latex_labels[y_name]['name']
        ...
        ax_2Dpane_XY.set_xlabel(xlabel,fontsize=25)
        ax_2Dpane_XY.set_ylabel(ylabel,fontsize=25)
        ...
        # Save to a File
        fn = '{}__{}.eps'.format(x_name,y_name)
        msg = "printing the image to {}".format(fn)
        print(msg)
...
if __name__ == "__main__":
    ...
    myplot.plot(x_name='p_NiNi_r0',y_name='d_Ni_r0')
