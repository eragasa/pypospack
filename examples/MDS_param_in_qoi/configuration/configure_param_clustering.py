...
pipeline_configuration[1]['function_calls'][0]['function'] = 'transform_mds'
...
pipeline_configuration[1]['function_calls'][0]['args']['kwargs']['mds'] = OrderedDict()
...
pipeline_configuration[3]['function_calls'][0]['args']['x_axis'] = 'mds_0'
pipeline_configuration[3]['function_calls'][0]['args']['y_axis'] = 'mds_1'
pipeline_configuration[3]['function_calls'][0]['args']['filename'] = 'param_clusters_in_mds_space.png'
