...
# define second segment (TSNE transformation)
...
pipeline_configuration[1]['function_calls'][0]['function'] = 'transform_tsne'
...
pipeline_configuration[1]['function_calls'][0]['args']['kwargs']['tsne'] = OrderedDict()
