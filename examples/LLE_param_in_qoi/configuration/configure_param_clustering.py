...
# define second segment (LLE transformation)
...
pipeline_configuration[1]['function_calls'][0]['function'] = 'transform_lle'
...
pipeline_configuration[1]['function_calls'][0]['args']['kwargs']['lle'] = OrderedDict()
...
pipeline_configuration[3]['function_calls'][0]['args']['x_axis'] = 'lle_0'
pipeline_configuration[3]['function_calls'][0]['args']['y_axis'] = 'lle_1'
pipeline_configuration[3]['function_calls'][0]['args']['filename'] = 'param_clusters_in_lle_space.png'
