...
from mpl_toolkits.axes_grid.inset_locator import inset_axes # for inset axes
...
pair_names2 = ['MgO_NaCl.c12.err','MgO_NaCl.c44.err']
axis2 = [0,100,0,100]

# plotting all the results
fig, axarr = plt.subplots(figsize=(8,4),ncols=2)
ax01 = axarr[0].scatter(srpp[0].get_data_frame(dt='abs_err',ds='results')[pair_names[0]],
                        srpp[0].get_data_frame(dt='abs_err',ds='results')[pair_names[1]],
                          s=1, color=rgb_results,label='results')
ax02 = axarr[0].scatter(srpp[0].get_data_frame(dt='abs_err',ds='pareto')[pair_names[0]],
                          srpp[0].get_data_frame(dt='abs_err',ds='pareto')[pair_names[1]],
                          s=1, color=rgb_pareto,label='pareto')
ax03 = axarr[0].scatter(srpp[0].get_data_frame(dt='abs_err',ds='culled')[pair_names[0]],
                          srpp[0].get_data_frame(dt='abs_err',ds='culled')[pair_names[1]],
                          s=1, color=rgb_culled,label='culled')
axarr[0].legend(handles=[ax01,ax02,ax03])
axarr[0].text(0.05,0.95,'N=1',
                verticalalignment = 'top', horizontalalignment = 'left',
                transform=axarr[0].transAxes,
                fontsize = 12,
                color='black', 
                bbox=dict(facecolor='white',edgecolor='black'))
axarr[0].axis((axis[0],axis[1],axis[2],axis[3]))
axarr[0].set_xlabel("$|$error in lattice parameter$|$ [$\AA$]")
axarr[0].set_ylabel("$|$error in B$|$ [GPa]")

ax31 = axarr[1].scatter(srpp[3].get_data_frame(dt='abs_err',ds='results')[pair_names[0]],
                          srpp[3].get_data_frame(dt='abs_err',ds='results')[pair_names[1]],
                          s=1,color=rgb_results,label='results')
ax32 = axarr[1].scatter(srpp[3].get_data_frame(dt='abs_err',ds='pareto')[pair_names[0]],
                          srpp[3].get_data_frame(dt='abs_err',ds='pareto')[pair_names[1]],
                          s=1,color=rgb_pareto,label='pareto')
ax33 = axarr[1].scatter(srpp[3].get_data_frame(dt='abs_err',ds='culled')[pair_names[0]],
                          srpp[3].get_data_frame(dt='abs_err',ds='culled')[pair_names[1]],
                          s=1,color=rgb_culled,label='culled')
#axarr[1].legend(handles=[ax31,ax32,ax33])
axarr[1].axis((axis[0],axis[1],axis[2],axis[3]))
axarr[1].set_xlabel("$|$error in lattice parameter$|$ [$\AA$]")
axarr[1].set_ylabel("$|$error in B$|$ [GPa]")

ax3i = inset_axes(axarr[1],width="50%",height="50%",
                  bbox_to_anchor=(0.0,0.0,1.0,1.0),
                  #bbox_to_anchor=(0,0,1,1),
                  bbox_transform=axarr[1].transAxes,
                  borderpad=1,
                  loc=1)
ai1 = ax3i.scatter(srpp[0].get_data_frame(dt='abs_err',ds='results')[pair_names2[0]],
                          srpp[0].get_data_frame(dt='abs_err',ds='results')[pair_names2[1]],
                          s=1, color=rgb_results,label='results')
ai2 = ax3i.scatter(srpp[0].get_data_frame(dt='abs_err',ds='pareto')[pair_names2[0]],
                          srpp[0].get_data_frame(dt='abs_err',ds='pareto')[pair_names2[1]],
                          s=1, color=rgb_pareto,label='pareto')
ai3 = ax3i.scatter(srpp[0].get_data_frame(dt='abs_err',ds='culled')[pair_names2[0]],
                          srpp[0].get_data_frame(dt='abs_err',ds='culled')[pair_names2[1]],
                          s=1, color=rgb_culled,label='culled')
ax3i.axis((axis2[0],axis2[1],axis2[2],axis2[3]))
ax3i.set_xlabel("$|$error in $c_{12}|$ [GPa]")
ax3i.set_ylabel("$|$error in $c_{44}|$ [GPa]")

fig.savefig(fname_plot,dpi=800)
