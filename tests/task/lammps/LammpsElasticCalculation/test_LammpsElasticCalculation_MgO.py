...
MgO_LC_configuration['task']['task_name'] = 'MgO_NaCl.elastic'
MgO_LC_configuration['task']['task_directory'] = 'MgO_NaCl.elastic'
MgO_LC_configuration['task']['task_type'] = 'lmps_elastic'
