...
MgO_LC_configuration['task']['task_name'] = 'MgO_NaCl.E_min_pos'
MgO_LC_configuration['task']['task_directory'] = 'MgO_NaCl.E_min_pos'
MgO_LC_configuration['task']['task_type'] = 'lmps_min_pos'
