...
Ni_task_configuration['task']['task_name'] = 'Ni_fcc_min.E_min_pos'
Ni_task_configuration['task']['task_directory'] = 'Ni_fcc_min.E_min_pos'
Ni_task_configuration['task']['task_type'] = 'lmps_min_pos'
