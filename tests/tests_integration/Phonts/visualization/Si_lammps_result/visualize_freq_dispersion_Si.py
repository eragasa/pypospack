...
def make_freq_dispersion_plot(
    ...
    for i in range(4,4+3*natoms):
        freq_dispersion_plot.plot(freq_dispersion_data[:,0],freq_dispersion_data[:,i])
    
    freq_dispersion_title=plt.title('Calculated phonon dispersion relation', fontname='Times New Roman')
    ...
    for i in range(1,11):
        freq_dispersion_vlines=plt.vlines(i*30,ylim[0],ylim[1])    
...
if __name__ == "__main__":
    ...
    phonts_sim_dir = 'Si_lammps_result'
