...
def start_pyposmat_mc_sampler(config_fn,results_fn):

    engine = PyposmatMonteCarloSampler(filename_in=filename_in,filename_out=filename_out)
...
if __name__ == "__main__":
    ...
    write_configuration_file(config_fn=config_fn)
    engine = start_pyposmat_mc_sampler(config_fn=config_fn,results_fn=results_fn)
    exit()
