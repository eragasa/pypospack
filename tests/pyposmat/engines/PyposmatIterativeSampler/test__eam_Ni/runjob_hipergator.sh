...
echo PATH=$PATH
#mpiexec -n 16 python Ni__eam__morse_exp_fs_2.py	> log.out
#mpirun python Ni__eam__morse_exp_fs_2.py > log.out
srun -n $SLURM_NTASKS --mpi=pmi2 python Ni__eam__morse_exp_fs_2.py > log.out 
