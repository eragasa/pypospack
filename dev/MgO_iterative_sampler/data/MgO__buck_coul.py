...
potential_formalism['potential'] = OrderedDict()
potential_formalism['potential']['potential_type'] = 'buckingham'
potential_formalism['potential']['symbols'] = ['Mg','O']

# <---------------- INITIAL PARAMETER DEFINITION
# units need to be in metal units
parameter_distribution = OrderedDict()
parameter_distribution['parameters'] = OrderedDict()
parameter_distribution['parameters']['chrg_Mg'] = ['uniform',{'a':+1.5,  'b':+2.5}]
parameter_distribution['parameters']['chrg_O']   = ['equals','-chrg_Mg']
parameter_distribution['parameters']['MgMg_A']   = ['equals',0.000]
parameter_distribution['parameters']['MgMg_rho'] = ['equals',0.500] 
parameter_distribution['parameters']['MgMg_C']    = ['equals',0.000]
parameter_distribution['parameters']['MgO_A']   = ['uniform',{'a':800.00,'b':1300.00}]
parameter_distribution['parameters']['MgO_rho'] = ['uniform',{'a':0.2900,'b':0.3300}]
parameter_distribution['parameters']['MgO_C']    = ['equals',0.000]
parameter_distribution['parameters']['OO_A']    = ['uniform',{'a':500.00,'b':25000.00}]
parameter_distribution['parameters']['OO_rho']  = ['uniform',{'a':0.1000,'b':0.4000}]
parameter_distribution['parameters']['OO_C']    = ['uniform',{'a':25.00, 'b':77.00}]
#------------------------------------------------------------------------------
