...
Ni_task_configuration['task']['task_name'] = 'Ni_fcc_unit.elastic'
Ni_task_configuration['task']['task_directory'] ='Ni_fcc_unit.elastic'
Ni_task_configuration['task']['task_type'] = 'lmps_elastic'
