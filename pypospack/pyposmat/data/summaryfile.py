...
class PyposmatSummaryFile(PyposmatConfigurationFile):
    """Class for reading, writing, and analyzing summary file
    ...
    def __init__(self,filename=None,configuration_fn=None):
